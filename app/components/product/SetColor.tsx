        ...
        <div>
            <div className="flex gap-4 items-center">
                ...
                <div className="flex gap-1">
                    {
                        images.map((image) => {
                            return <div onClick={()=>handleColorSelect(image)} key={image.color} className={`h-7 w-7 rounded-full border-teal-300 flex items-center justify-center ${cartProduct.selectedImg.color === image.color ? 'border-[1.5px]' : 'border-none' }`}>
